...
module gantry_endstop() {
    ...
    union() {
        ...
        translate([25, -16, 30]) rotate([180,-90,0]) tension_bracket();
        translate([29,0,12]) rotate([-90,180,0]) 
            linear_extrude(2.5) polygon([[0,0], [29,0], [0,34]]); 
        translate([25,0,8]) rotate([0,0,180]) 
            linear_extrude(2.5) polygon([[0,0], [25,0], [0,32]]); 
        translate([29,0,8]) rotate([0,90,180]) 
            linear_extrude(4) polygon([[0,0], [8,0], [0,32]]); 
